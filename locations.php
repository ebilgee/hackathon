...
<section>
	<div class="container">
		...
		<div class="col-md-3">
			<a href=""><img style="width:100%" src="images/locations/2.jpg"></a>
			<h5>Arc de Triomphe</h5>
		</div>
		<div class="col-md-3">
			<a href=""><img style="width:100%" src="images/locations/1.jpg"></a>
			<h5>Louvre</h5>
		</div>
		<div class="col-md-3">
			<a href=""><img style="width:100%" src="images/locations/4.jpg"></a>
			<h5>Musee de Armee</h5>
		</div>
	...
	<div class="container">
		<h3>Marsel</h3>
		<div class="col-md-3">
			<a href=""><img style="width:100%" src="images/locations/5.jpg"></a>
			<h5>Old Port</h5>
		</div>
		<div class="col-md-3">
			<a href=""><img style="width:100%" src="images/locations/9.jpg"></a>
			<h5>De La Garde</h5>
		</div>
